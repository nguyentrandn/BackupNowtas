...
<div class="main">
	<div class="colorbg"style="background-image:url(/source/image/<?php echo e($detail2 -> Film_bgr); ?>)" width="100%">
		<div class="mainn">
				<div class="mainleft">
					<div class="img-movie">
						<a href=""><img src="/source/image/<?php echo e($detail2 -> Film_img); ?>"  alt="" height="500px"></a>
					</div>
				...
				<div class="mainright">
					<div class="container">
						...
						<a class="icon1" href=""><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a>
								...
								<a href="<?php echo e(route('chitiet-movie-phim-le',$detail2->id)); ?>"><button class='button-watch'>Xem ngay</button>		</a>						
								</div>
		...
		<div class="move-film">
			...
			<?php $__currentLoopData = $detail2_tuongtu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sptt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>																		
				<div class="rowmini">
					...
					<a href="<?php echo e(route('chitiet-movie-phim-le',$sptt2->id)); ?>"><img src="/source/image/<?php echo e($sptt2 -> Film_img); ?>"  alt="" height="250px" width="180px"></a>
						<a class="icon1" href=""><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a>
						<a class="icon2" href=""><i class="fas fa-star"></i></a>
					</div>
					<div class="item-body">
...
</html><?php /**PATH C:\xampp\htdocs\project_film1\resources\views/do_an/chitiet-movie-phim-le.blade.php ENDPATH**/ ?>