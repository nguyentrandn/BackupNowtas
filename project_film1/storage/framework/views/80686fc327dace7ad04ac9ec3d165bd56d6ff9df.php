		...
		<div class="mainright">
			...
			<div class="right2-scroll">
				...
				<?php $__currentLoopData = $scrolls2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scr2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr class="item-scroll">
						<td class="image-scroll">
						<a href="<?php echo e(route('chitiet-movie-phim-le',$scr2->id)); ?>"><img src="/uploads/<?php echo e($scr2 -> Film_img); ?>"  alt="" height="70px" width="57px"></a>
						</td>														
						<td class="title-scroll">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project_film1\resources\views/do_an/home.blade.php ENDPATH**/ ?>