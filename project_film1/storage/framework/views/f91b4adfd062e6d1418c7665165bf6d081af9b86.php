...
<div class="top">
	<header>
		...
		<div class="topright">
			<ul><?php $__currentLoopData = $loai_sp_bo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp_bo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li><a id="page" href="<?php echo e($sp_bo->Link_Category); ?>"><?php echo e($sp_bo->Name_Category); ?></a></li>
...
<div class='topmini1'> 			
    <div class="timkiem1">						
        <input type="text" name="" class="inputtimkiem1" placeholder="Tìm Kiếm Trên SS Phim..."/>
            <a class="nut1">
                <div class="tool1">
...
<div class="main">
    ...
    <?php $__currentLoopData = $phimbos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phimbo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row2">
            ...
            <a href="<?php echo e(route('chitiet-movie-phim-bo',$phimbo->id)); ?>"><img src="<?php echo e(URL::To('storage/'.$phimbo -> Film_img)); ?>"  alt="" height="250px" width="180px"></a>
...
</html><?php /**PATH D:\xampp\htdocs\project_film1\resources\views/do_an/phim-bo.blade.php ENDPATH**/ ?>