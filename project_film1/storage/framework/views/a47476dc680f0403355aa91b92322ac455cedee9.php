				...
				<div class="mainright">
					<div class="container">
						...
						<a class="icon1" href=""><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a>
								...
								<a href="<?php echo e(route('chitiet-movie-phim-bo',$detail->id)); ?>"><button class='button-watch'>Xem ngay</button>		</a>				
								</div>
...
</html><?php /**PATH C:\xampp\htdocs\project_film1\resources\views/do_an/chitiet-movie-phim-bo.blade.php ENDPATH**/ ?>