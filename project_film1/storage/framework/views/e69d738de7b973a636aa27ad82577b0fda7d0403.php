					...
					<div class="container">
						...
						<a class="icon1" href=""><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a>
								...
								<div class='watch'>
									...
									<button class='button-watch'><a href="<?php echo e(route('chitiet-movie-phim-le',$detail2->id)); ?>">Xem ngay</a></button>						
								</div>
...
</html><?php /**PATH C:\xampp\htdocs\project_film\resources\views/do_an/chitiet-movie-phim-le.blade.php ENDPATH**/ ?>