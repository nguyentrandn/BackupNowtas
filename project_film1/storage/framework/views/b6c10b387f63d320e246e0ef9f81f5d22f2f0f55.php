...
<div class="main">
	<div class="colorbg"style="background-image:url(<?php echo e(URL::To('storage/'.$detail -> Film_bgr)); ?>)" width="100%">
		<div class="mainn">
				<div class="mainleft">
					<div class="img-movie">
						<a href=""><img src="<?php echo e(URL::To('storage/'.$detail -> Film_img)); ?>"  alt="" height="500px"></a>
					</div>
				...
				<div class="mainright">
					<div class="container">
						...
						<a class="icon1" href=""><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a>
								...
								<a href="<?php echo e(route('watch-le',$detail->id)); ?>"><button class='button-watch'>Xem ngay</button>		</a>				
								</div>
...
</html><?php /**PATH D:\xampp\htdocs\project_film1\resources\views/do_an/chitiet-movie-phim-bo.blade.php ENDPATH**/ ?>