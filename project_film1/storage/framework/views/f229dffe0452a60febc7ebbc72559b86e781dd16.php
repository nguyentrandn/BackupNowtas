...
<html>
	<head>
		...
		<title>	<?php echo e($detail2->Film_name); ?> </title>
...
<div class="top">
	<header>
		<div class="topleft">
			<a href="<?php echo e(route('home')); ?>"><img src="/source/image/logo.png" alt="" height="60px"></a>
		</div>
		<div class="topright">
			<ul>
				<li><a id="page" href=""> Phim Lẻ </a></li>
				<li><a id="page" href="<?php echo e(route('phim-bo')); ?>"> Phim Bộ </a></li>
...
<div class="main">
	<div class="colorbg"style="background-image:url(<?php echo e(URL::To('storage/'.$detail2 -> Film_bgr)); ?>)" width="100%">
		<div class="mainn">
				<div class="mainleft">
					<div class="img-movie">
						<a href=""><img src="<?php echo e(URL::To('storage/'.$detail2 -> Film_img)); ?>"  alt="" height="500px"></a>
					</div>
				...
				<div class="mainright">
					<div class="container">
						...
						<h1 id="title"><?php echo e($detail2->Film_name); ?></h1>
						<a class="icon1" href=""><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a>
								...
								<a href="<?php echo e(route('watch-le',$detail2->id)); ?>"><button class='button-watch'>Xem ngay</button>		</a>						
								</div>
						<div class="information">
							<ul>
								<li>Đạo diễn: <?php echo e($detail2->Film_director); ?> </li>
								<li>Thời gian: <?php echo e($detail2->Film_time); ?> </li>							
								<li>Quốc gia: <?php echo e($detail2->country); ?> </li>
								<li>Năm phát hành: <?php echo e($detail2->Film_year); ?></li>
								<li>Thể loại: <?php echo e($detail2->Film_category); ?> </li>
								<li>Số tập: <?php echo e($detail2->Film_number); ?></li>
							</ul>
						</div>
	...
	<div class="content">
		<div class="content1">
			...
			<p><?php echo e($detail2->Film_info); ?>	</p>
		
			<h1 class="title-content" id="about">Official trailer:	</h1>
			<iframe width="800" height="448" src="<?php echo e($detail2 ->Film_vd); ?>" title="YouTube video player" 
		...
		<div class="move-film">
			...
			<div class="row">
			<?php $__currentLoopData = $detail2_tuongtu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sptt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>																		
				<div class="rowmini">
					<div class="item-header">
					<a href="<?php echo e(route('chitiet-movie-phim-le',$sptt2->id)); ?>"><img src="<?php echo e(URL::To('storage/'.$sptt2 -> Film_img)); ?>"  alt="" height="250px" width="180px"></a>
						<a class="icon1" href=""><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a>
						<a class="icon2" href=""><i class="fas fa-star"></i></a>
					</div>
					<div class="item-body">
						<p class="item-title"><?php echo e($sptt2 -> 	Film_name); ?></p>																						
					</div>
...
</html><?php /**PATH D:\xampp\htdocs\project_film1\resources\views/do_an/chitiet-movie-phim-le.blade.php ENDPATH**/ ?>