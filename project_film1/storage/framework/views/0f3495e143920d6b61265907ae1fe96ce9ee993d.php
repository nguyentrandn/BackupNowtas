...
<html>
	<head>
		...
		<title>	<?php echo e($detail3->Film_name); ?> </title>
...
<div class="main">
	<div class="colorbg"style="background-image:url(<?php echo e(URL::To('storage/'.$detail3 -> Film_bgr)); ?>)" width="100%">
		<div class="mainn">
				<div class="mainleft">
					<div class="img-movie">
						<a href=""><img src="<?php echo e(URL::To('storage/'.$detail3 -> Film_img)); ?>"  alt="" height="500px"></a>
					</div>
				...
				<div class="mainright">
					<div class="container">
						...
						<h1 id="title"><?php echo e($detail3->Film_name); ?></h1>
						...
						<div class="information-le">
							<ul>
								<li>
                                    <p><?php echo e($detail3->Film_info); ?></p>
                                </li>
							</ul>
						</div>
	...
	<div class="content">
		<div class="content1">
              <video controls autoplay name="media" style="width:800px">
            <source src="<?php echo e($detail3 ->Film_watch); ?>" type="video/mp4" >
            </video> 
		...
		<div class="move-film">
			...
			<div class="row">
			<?php $__currentLoopData = $detail3_tuongtu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sptt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>																		
				<div class="rowmini">
					<div class="item-header">
					<a href="<?php echo e(route('chitiet-movie-phim-le',$sptt->id)); ?>"><img src="<?php echo e(URL::To('storage/'.$sptt -> Film_img)); ?>"  alt="" height="250px" width="180px"></a>
						<a class="icon1" href=""><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></a>
						<a class="icon2" href=""><i class="fas fa-star"></i></a>
					</div>
					<div class="item-body">
	...
	<div class="searchmain2">
		<div class="timkiem">						
			<input type="text" name="" class="inputtimkiem" placeholder="Tìm Kiếm Trên SS Phim..."/>
				<a class="nut">
					<div class="tool">
...
</html><?php /**PATH D:\xampp\htdocs\project_film1\resources\views/do_an/watch-le.blade.php ENDPATH**/ ?>