...
<div class="main">
	<div class="colorbg"style="background-image:url({{URL::To('storage/'.$detail3 -> Film_bgr)}})" width="100%">
		<div class="mainn">
				<div class="mainleft">
					<div class="img-movie">
						<a href=""><img src="{{URL::To('storage/'.$detail3 -> Film_img)}}"  alt="" height="500px"></a>
					</div>
				...
				<div class="mainright">
					<div class="container">
						...
						<h1 id="title">{{ $detail3->Film_name }}</h1>
	...
	<div class="content">
		<div class="content1">
            ...
            <source src="{{$detail3 ->Film_watch}}" type="video/mp4" >
            </video> 
		...
		<div class="move-film">
			...
			<div class="row">
			@foreach($detail3_tuongtu as $sptt)																		
				<div class="rowmini">
