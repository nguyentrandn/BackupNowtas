...
<div class="top">
	<header>
		...
		<div class="topright">
			<ul>@foreach ($loai_sp_bo as $sp_bo)
					<li><a id="page" href="{{$sp_bo->Link_Category}}">{{$sp_bo->Name_Category}}</a></li>
				@endforeach	
			</ul>
		</div>
	</header>
...
<div class="main">
	<div class="mainn2">
    @foreach ($phimbos as $phimbo)
        <div class="row2">
																		
            <div class="item-header">
            <a href="{{route('chitiet-movie-phim-bo',$phimbo->id)}}"><img src="{{URL::To('storage/'.$phimbo -> Film_img)}}"  alt="" height="250px" width="180px"></a>
            ...
            <div class="item-body">
                <p class="item-title">{{ $phimbo->Film_name }}</p>																						
            </div>
            <div class="item-caption">								
                <a class="beta-btn primary" href="{{route('chitiet-movie-phim-bo',$phimbo->id)}}">Xem phim </a>								
            </div>
