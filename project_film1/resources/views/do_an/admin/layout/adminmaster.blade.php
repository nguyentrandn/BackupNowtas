...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Admin: {{Auth::user()->full_name }}</title>
            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive" src="/source/image/{{Auth::user()->image }}" width="55px" height="70px" alt="#"/> </div>
                        <div class="user_info">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        <a href="{{route('admin.getHome')}}"><i class="fa fa-dashboard yellow_color"></i> <span>Dashboard</span></a>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                           <li><a href="{{route('admin.getCateList')}}">> <span>Category list</span></a></li>
                           <li><a href="{{route('admin.getCateAdd')}}">> <span>Category add </span></a></li>        
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="apps">
                           <li><a href="{{route('admin.getUser')}}">> <span>Accounts list</span></a></li>
                           <li><a href="{{route('admin.getsignin')}}">> <span>Accounts add</span></a></li>
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="additional_page">
                           <li>
                              <a href="{{route('admin.getProductList')}}">> <span>Products list</span></a>
                           </li>
                           <li>
                              <a href="{{route('admin.getProductAdd')}}">> <span>Products add</span></a>
                           </li>
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="/source/image/{{Auth::user()->image }}" alt="#" /><span class="name_user">{{Auth::user()->full_name }}</span></a>
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="profile.html">My Profile</a>
                                       <a class="dropdown-item" href="settings.html">Settings</a>
                                       <a class="dropdown-item" href="help.html">Help</a>
                                       <a class="dropdown-item" href="{{ route('getlogout') }}" onclick="return confirm('bạn có chắc không??')"><span>Log Out</span> <i class="fa fa-sign-out"></i></a>
                                    </div>
                                 </li>
                              </ul>
                           </div>
