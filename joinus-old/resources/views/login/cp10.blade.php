...
<body>
	...
	<main class="CP10">
		...
		<div class="mv">
			<h2 class="pageTtl">パスワードの再発行</h2>
			<p class="lead">ご登録いただいたメールアドレスにパスワード再設定用のリンクをお送りします。</p>
		</div>
		...
		<div class="inner">
			<form>
				...
				<button type="submit" class="cBtn style1" onclick="location.href=''">再設定用のメールを送信する</button>
			</form>
		</div>
	</main>
