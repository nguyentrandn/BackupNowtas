...
<form onsubmit="return false">
    <div class="container search-form">
        <div class="row w-100 address-bar m-1  px-5">
                ...
                <div class="drop_hide" id="drop_list">
                    ...
                    {{-- -------------------------------- --}}
                        <div class="drop_scroll">
                            <div class="drop_option" id="drop">
                                <div class="col col-1 d-inline"><input type="checkbox" name="" id=""></div>
                                <div class="col pe-3 d-inline" id="">
                                    <img src="/admin/image/avt.svg" alt="">
                                </div>
            ...
            <div class="col col-lg-6" style="height: 100%; overflow-x: scroll;">
                <ul id="tag" style="display: flex; margin-top: 7%; gap: 0 40px;">
...
<script>
    ...
    function addTags(){   
        ...
        var newText = document.createTextNode("abc");
