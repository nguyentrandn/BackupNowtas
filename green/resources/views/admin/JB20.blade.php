    ...
    <form class="row-conten" id="form" onsubmit="return false">
        ...
        <div class="form-group-checkbox">
            ...
            <div class="coll-md-8 edit-padding ps-3">
                <div class="col-md-3">
                    <input type="checkbox" style="transform: scale(1.3);" name="" id="身元確認者希望"> <label for="身元確認者希望">身元確認者希望 </label><br>
                    <input type="checkbox" style="transform: scale(1.3);" name="" id="シニア歓迎"> <label for="シニア歓迎"> シニア歓迎 </label>
                </div>
                <div class="col-md-3">
                    <input type="checkbox" style="transform: scale(1.3);" name="" id="送迎なし"> <label for="送迎なし">送迎なし </label><br>
                    <input type="checkbox" style="transform: scale(1.3);" name="" id="ファミリー歓迎"> <label for="ファミリー歓迎"> ファミリー歓迎 </label>
                </div>
                <div class="col-md-3">
                    <input type="checkbox" style="transform: scale(1.3);" name="" id="女性歓迎"> <label for="女性歓迎">女性歓迎 </label><br>
                    <input type="checkbox" style="transform: scale(1.3);" name="" id="男性歓迎"> <label for="男性歓迎"> 男性歓迎 </label>
                </div>
                <div class="col-md-3">
                    <input type="checkbox" style="transform: scale(1.3);" name="" id="若者歓迎">若者歓迎 </label><br>
                    <input type="checkbox" style="transform: scale(1.3);" name="" id="未経験者歓迎"> <label for="未経験者歓迎"> 未経験者歓迎 </label>
                </div>
            </div>
        </div>
        <div class="form-group">
