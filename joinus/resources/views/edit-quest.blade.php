...
@section('content')
<div class="container">
    <div class="create-quest-page edit-quest-page">
      <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="home-logged">ホーム</a></li>
          <li class="breadcrumb-item"><a href="quest-list">依頼クエスト管理</a></li>
          <li class="breadcrumb-item active" aria-current="page">クエスト名</li>
        </ol>
      </nav>

      <div class="create-quest-main edit-quest-main">
        <h2 class="big-title">クエスト編集</h2>
        ...
        <div class="nav-tab">
          ...
          <div class="nav-item">
            <a href="edit-quest-2" class="nav-link">応募者</a>
          </div>
        </div>
          ...
          <div class="category">
            ...
            <div class="content">
              ...
              <div class="input-item">
                ...
                <textarea class="input textarea-single" name="" id="" cols="30" rows="1"
                  placeholder="ギルドとは別に依頼主がいる場合は依頼主名を入力"></textarea>
              </div>
              ...
              <div class="input-item">
                ...
                <textarea class="input textarea-single" name="" id="" cols="30" rows="1"
                  placeholder="学生、旅人など具体的に書くとより集まりやすくなります。"></textarea>
              ...
              <div class="input-item">
                ...
                <div class="upload-group">
                  <div class="upload-img">
                    <img srcset="/joinus/img/upload-img-1.jpg 2x" alt="">
                  ...
                  <button class="btn btn-outline upload-btn">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M11.0008 14.986C11.0008 15.2512 11.1061 15.5056 11.2936 15.6931C11.4812 15.8806 11.7355 15.986 12.0008 15.986C12.266 15.986 12.5203 15.8806 12.7079 15.6931C12.8954 15.5056 13.0008 15.2512 13.0008 14.986V7.828L16.2437 11.071L17.6577 9.657L12.0008 4L6.34375 9.657L7.75775 11.071L11.0008 7.83V14.987V14.986Z"
                        fill="#5488AD" />
                      <path
              ...
              <div class="input-item">
                ...
                <div class="upload-img-list">
                  <div class="upload-img">
                    <img srcset="/joinus/img/upload-img-2.jpg 2x" alt="">
                  ...
                  <div class="upload-img">
                    <img srcset="/joinus/img/upload-img-3.jpg 2x" alt="">
                  ...
                  <div class="upload-img">
                    <img srcset="/joinus/img/upload-img-4.jpg 2x" alt="">
                  ...
                  <span class="tag-item">
                    ...
                    <div class="close-icon">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M10 1.25C5.125 1.25 1.25 5.125 1.25 10C1.25 14.875 5.125 18.75 10 18.75C14.875 18.75 18.75 14.875 18.75 10C18.75 5.125 14.875 1.25 10 1.25ZM13.375 14.375L10 11L6.625 14.375L5.625 13.375L9 10L5.625 6.625L6.625 5.625L10 9L13.375 5.625L14.375 6.625L11 10L14.375 13.375L13.375 14.375Z" fill="#FFB7B7"/>
                        </svg>
                    </div>
