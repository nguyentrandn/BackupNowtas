...
<head>
    ...
    <link rel="stylesheet" href="./css/FD20.css">
                    ...
                    <form class="row-conten g-3" id="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <input class="form-control " id="ファンド名" name="ファンド名" placeholder="ファンド名を入力" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="coll-md-3 ">
                            ...
                            <div class="coll-md-8 ">
                                <input id="1-option" value="新規" name="新規／継続" type="radio"> <label for="1-option"><b> 新規 </b> </label>
                                <input id="2-option" value="継続" name="新規／継続" type="radio"> <label for="2-option"> <b> 継続 </b></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="coll-md-3 ">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="予定分配率" placeholder="数字を入力" type="number">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="募集金額" placeholder="数字を入力" type="number">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding" onclick="date2()">
                                <div class="w30">
                                    <input id="txtfrom2" name="募集期間（日時）_from" class="form-control w30" placeholder="🗓&emsp; 開始日を入力">
                                </div>
                                <div class="or">〜</div>
                                <div class="w30">
                                    <input class="form-control w30" name="募集期間（日時）_to" id="txtto2" placeholder="🗓&emsp; 終了日を入力">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                ...
                                <select class="form-select" name="募集種別">
                                    <option value="募集種別を選択"><p>募集種別を選択</p></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="form-both1">
                                    <input type="file" name="メイン画像" id="choose-file" />
                                </div>
                        ...
                        <div class="form-group">
                            <div class="coll-md-3 ">
                                <label for="物件名称" class="form-label">所在地</label>
                                <div class="nhan">必須</div>
                            </div>
                            <div class="coll-md-8 edit-padding">
                        ...
                        <div class="form-group">
                            <div class="coll-md-3 ">
                                <label for="物件名称" class="form-label">交通</label>
                                <div class="nhan">必須</div>
                            </div>
                            <div class="coll-md-8 edit-padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <input class="form-control" name="構造" placeholder="選択してください" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="coll-md-3 ">
                                <label for="面積" class="form-label">床面積</label>
                                <div class="nhan">必須</div>
                            </div>
                            <div class="coll-md-8 edit-padding">
                        ...
                        <div class="form-group">
                            <div class="coll-md-3 ">
                                <label for="権利" class="form-label">築年月</label>
                                <div class="nhan">必須</div>
                            </div>
                            <div class="coll-md-8 edit-padding">
                                <input class="form-control" name="築年月" placeholder="選択してください" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="coll-md-3 ">
                                <label for="権利" class="form-label">容積率</label>
                                <div class="nhan">必須</div>
                            </div>
                            <div class="coll-md-8 edit-padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding" onclick="date3()">
                                <div class="w30">
                                    <input id="txtfrom3" name="現契約期間_from" class="form-control w30" placeholder="🗓&emsp; 数字を入力 ">
                                </div>
                                <div class="or">〜</div>
                                <div class="w30">
                                    <input class="form-control w30" id="txtto3" name="現契約期間_to" placeholder="🗓&emsp; 数字を入力  ">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="敷金" placeholder="数字を入力" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <textarea class="form-control" name="契約更改の方法" placeholder="入力してください"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="coll-md-3 ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="物件価格" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="賃料収入" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="維持管理費" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="修繕積立金" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="公租公課" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="火災保険料" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="PMフィー" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="税理士報酬" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="その他" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30" name="優先出資分配金" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <input class=" form-control " id="商号" name="商号" placeholder="入力してください" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="coll-md-3 ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                <div class="w30">
                                    <input class="form-control w30 " name="郵便番号" placeholder="数字を入力" type="number" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="coll-md-8 edit-padding">
                                ...
                                <select class="form-select" name="都道府県">
                                    <option value="募集種別を選択"><p> 募集種別を選択 </p></option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                </select>
                        ...
                        <div class="button-submit">
                            <button type="submit" class="bt-save">一時保存</button>
                        </div>
                    </form>
                </div>
            </div>
